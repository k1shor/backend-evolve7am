...
const { addProduct, productlist, productlistByCategory, productDetails, updateProduct, deleteProduct, getFilteredProducts, getRelatedProducts } = require('../controller/productController')
